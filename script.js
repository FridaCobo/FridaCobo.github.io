document.addEventListener("DOMContentLoaded", function () {
  ...
  volverBtnCategoria.addEventListener("click", () => {
    ...
    descripcionImagenSection.classList.add("oculto"); // Asegurarse de que la descripción también se oculte
  });
  ...
  volverBtnDescripcion.addEventListener("click", () => {
    ...
    }, 300); // Esperar a que termine la transición antes de ocultar completamente
  });
